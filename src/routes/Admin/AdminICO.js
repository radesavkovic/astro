...
const AdminICO = (props) => {
  ...
  const receiver_Validation = () => {
    ...
    else if (isEmpty(input_data.x_rktl_receiver)) {
      $(`input[name='x_rktl_receiver']`).focus();
      result = false;
    }
  ...
  const fee_Validation = () => {
    ...
    else if (isEmpty(input_data.x_rktl_fee)) {
      $(`input[name='x_rktl_fee']`).focus();
      result = false;
    }
            ...
            <section className='presale-content'>
              <section className='admin-presale-inner pt-3 pb-4'>
                <div className="row gap-2">
                  ...
                  <div className='col-md-12'>
                    <div className='admin-input-section'>
                      <span className='text-left'>Min Cap ($BUSD)</span>
                  ...
                  <div className='col-md-12'>
                    <div className='admin-input-section'>
                      <span className='text-left'>Max Cap ($BUSD)</span>
                  ...
                  <div className='col-md-12'>
                    <div className='row gap-row-2'>
                      ...
                      <div className='col-md-6'>
                        <div className='flex flex-column'>
                          <span className='text-left'>xRKTL Receiver</span>
                          <input name="x_rktl_receiver" type="text" onChange={handleChange}></input>
                        </div>
                      </div>
                      <div className='col-md-6'>
                        <div className='flex flex-column'>
                    ...
                    <div className='row gap-row-2'>
                      ...
                      <div className='col-md-6'>
                        <div className='flex flex-column'>
                          ...
                          <input name="fee_kind" type="number" onChange={handleChange}></input>
                        </div>
                      </div>
                      <div className='col-md-6'>
                        <div className='flex flex-column'>
                      ...
                      <div className='col-md-6'>
                        <div className='flex flex-column'>
                          <span className='text-left'>xRKTL Fee</span>
                          <input name="x_rktl_fee" type="number" onChange={handleChange}></input>
                        </div>
                      </div>
                      <div className='col-md-6'>
                        <div className='flex flex-column'>
